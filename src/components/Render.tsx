  ...
  return (
    <>
      <div className="flex h-full">
        <aside
          className="w-12 bg-[var(--bg-1)] border-r border-[var(--white-05)] flex flex-col h-screen"
          data-component="navbar"
        >
          <ul className="flex flex-1 flex-col h-screen p-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <li className="self-center">
                <button
                  ...
                  data-align="center"
                  onClick={async () => {
                    await window.tabs.createTab("https://discord.night-x.com/")
                  }}
                >
        ...
        <div className="flex-1">
                  ...
                  >
                    <ul className="py-1 text-sm text-[var(--text)]">
                      <li
                        ...
                        onClick={async () => {
                          await window.tabs.createTab("ddx://newtab/")
                        }}
                      >
                        <Plus className="h-4 w-4" />
                        <span>New Tab</span>
                      ...
                      <li className="px-4 py-2 hover:bg-[var(--white-10)] cursor-pointer flex gap-1 items-center"
                        onClick={async () => {
          ...
          <div
            className="h-[calc(100vh-96px)] w-full bg-[var(--bg-2)]"
