...
export class ChromeRuntime {
  ...
  public dynamicId: string = "c2e183bf-7b7f-48ec-84ea-af47dc04b411";
  public id: string = "jenfpleejnfmlcmmfcblmnpdhdfnfnmg";
  ...
  getBackgroundPage(...args: any[]): any {
    throw new Error('chrome.runtime.getBackgroundPage is not implemented');
  }
  ...
  getPackageDirectoryEntry(...args: any[]): any {
    throw new Error('chrome.runtime.getPackageDirectoryEntry is not implemented');
  }
  ...
  getVersion(...args: any[]): any {
    throw new Error('chrome.runtime.getVersion is not implemented');
  }
