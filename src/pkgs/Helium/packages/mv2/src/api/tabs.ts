...
export class ChromeTabs {
  ...
  executeScript(...args: any[]): any {
    throw new Error('chrome.tabs.executeScript is not implemented');
  }
  ...
  getAllInWindow(...args: any[]): any {
    throw new Error('chrome.tabs.getAllInWindow is not implemented');
  }
  ...
  getSelected(...args: any[]): any {
    throw new Error('chrome.tabs.getSelected is not implemented');
  }
  ...
  insertCSS(...args: any[]): any {
    throw new Error('chrome.tabs.insertCSS is not implemented');
  }
  ...
  removeCSS(...args: any[]): any {
    throw new Error('chrome.tabs.removeCSS is not implemented');
  }
  ...
  sendRequest(...args: any[]): any {
    throw new Error('chrome.tabs.sendRequest is not implemented');
  }
